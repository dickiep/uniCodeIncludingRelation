                ...
                <div class ="row">
                    <div class = "col-lg-12">
                        ...
                        <ol class="breadcrumb" id="mybreadcrumb">
                            ...
                            <li>
                                <a href="#" id="breadcrumbitem">&nbsp;Edit &amp; Delete Users</a>
                            </li>
                        </ol>
                        ...
                        <?php
                            ...
                            $userQuery = "SELECT firstName, lastName, emailAddress, pword, id, vleUserTypes.userTypeDescription FROM vleUsers join vleUserTypes on vleUsers.userType = vleUserTypes.idUserType";
                            ...
                            if(mysqli_num_rows($userResult)>0) {
                                while ( $row = mysqli_fetch_assoc($userResult) ) {
                                    ...
                                    echo("</td><td>");
                                    echo(htmlentities($row['emailAddress']));
                                    echo("</td><td>");
                                    echo(htmlentities($row['pword']));
                                    echo("</td><td>");
                                    echo(htmlentities($row['userTypeDescription']));
                                    echo("</td><td>");
