                ...
                <div class ="row">
                    <div class = "col-lg-12">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <li>
                                <a href='viewModuleResources.php?id=<?php
                                $queryModule = "SELECT DISTINCT moduleCode FROM vleModuleResources JOIN vleModuleResourceFolders ON vleModuleResources.folderID = vleModuleResourceFolders.id WHERE folderID='$folderid'";$resultModule = mysqli_query($conn, $queryModule) or die(mysqli_error($conn));if(mysqli_num_rows($resultModule)>0) {while($row = mysqli_fetch_assoc($resultModule)) {$moduleCodeLink = mysqli_real_escape_string($conn, $row['moduleCode']);echo"$moduleCodeLink' class='active' id='breadcrumbitem'>&nbsp;Resource Folders&nbsp;</a>";}}?>
                            </li>
                            <li>
                            <i class="fas fa-angle-double-right" id="breadcrumbitem"></i>
                            </li>
