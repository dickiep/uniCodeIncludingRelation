			...
			<div class="container">			
				...
				<div class="row">									
					<section class="8u">				
                        ...
                        <h1>DISPLAY STUDENT SCORE</h1>



                        <?php
                            $displayid=$_GET['studentid'];
                            echo "<p>$displayid</p>";
                            $query = "SELECT * FROM quizresults06 WHERE id=$displayid";
						...
						<h1>QUIZ ON AFRICA PLAINS STUDENT SCORES</h1>
                            <?php
                                ...
                                $emaildata=$row['email'];
                                echo " <div class='summaryboxfull'>
                                name: $name
                                <br>score:$scoredata
                                <br>$submitdata
                                <br> <a href='mailto:$emaildata'>$emaildata</a>
                                </div>";
                                }
                                }else{
