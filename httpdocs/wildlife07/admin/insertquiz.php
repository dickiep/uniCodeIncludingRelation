										...
										<li>
											<a href="#">Africa</a>
												<ul>
													...
													<li><a href="plains.php">Plains</a></li>
				...
				<div class="row">									
					<section class="8u">				
                        ...
                        <?php
                            ...
                            echo "$titledata<br/>$picname <br/>$pictemp<br/>";
                            echo "question01:$q01data<br/>$c01adata<br/>$c01bdata<br/>$a01data";
                        ?>
