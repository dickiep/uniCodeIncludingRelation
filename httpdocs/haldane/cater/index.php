            ...
            <div class = "container-fluid">
                <div class ="row">
                    <div class = "col-lg-12">
                        ...
                        <h1>Welcome to <i>HF</i> Training <?php echo"$first"?></h1>
                        ...
                        <div class="row">
                            ...
                            <div class='card' id = 'myindexcard'>
                                <i class="fas fa-graduation-cap fa-10x cardicon" style="color: #004811; background: #fafafa"></i>

                                    <div class='card-body'>
                                        <h5 class='card-title'>Access and use your Training Resources</h5>
                            ...
                            <div class='card' id = 'myindexcard'>
                                ...
                                <i class="fas fa-comments fa-10x cardicon" style="color: #dcdddf; background: #fafafa"></i>

                                    <div class='card-body'>
                                        <h5 class='card-title'>Send your colleagues or instructor a message</h5>
                                        <a href='messenger.php' class='btn btn-primary'>Messenger</a>
                                    </div>
                            </div>
                            
                             <div class='card' id = 'myindexcard'>
                                <i class="fas fa-briefcase fa-10x cardicon" style="color: #e23940; background: #fafafa"></i>
