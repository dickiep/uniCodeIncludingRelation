                            ...
                            <ol class="breadcrumb" id="mybreadcrumb">
                                ...
                                <div class="row">
                                    ...
                                    if(isset($_SESSION['updateSuccess'])) {
                                        ...
                                        echo"<p class='sessionSuccess'>$success</p>";
                                        ...
                                        <h4 class='card-title' id='admincardtitle' >Your Personal Details</h4>
                                            <div class='card-body' id='admincardbodypd'>
                                             <form method='POST' action=updateauser.php>
                                              ...
                                              <p id='pd'><strong>Given Name :</strong><input type='text' class='form-control' name='firstName' value='$first'></p>
                                              <p id='pd'><strong>Family Name :</strong><input type='text' class='form-control'name='lastName' value='$last'></p>
                                              <p id='pd'><strong>Email Address :</strong><input type='email' class='form-control' name='emailAddress' value='$mail'></p>
                                            </form>        
                                            </div>
                                       </div>";
                                    ?>    
                                ...
                                <div class='card' id = 'myadmincard'>
                                    <i class="fas fa-user-secret fa-10x cardicon"></i>
                                       <div class='card-body'>
                                          <h5 class='card-title'>Click here to update your user details</h5>
                                          <a href='updateuser.php' class='btn btn-primary'>Update your details</a>
                                       </div>
                                </div>
                            </div>
                        </div>     
